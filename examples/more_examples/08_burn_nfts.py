...
types = [
    "lion", "elephant", "panda", "sloth", "tiger", "wolf"
]
...
receive_address=Address(payment_part=receive_skey.to_verification_key().hash(), staking_part=staking_skey.to_verification_key().hash(),network=cardano_network)
...
signed_tx = builder.build_and_sign([receive_skey, policy_signing_key], change_address=receive_address)
